...
const Certifications = () => {
  ...
  const certifications = [
    ...
    },
    {
      ...
      issuer: "Valued Academy",
      date: "April 5, 2026",
      description: "Official certification recognizing completion of the Succour For Nations Development Program",
      skills: ["Personality & Self Discovery", "Critical Thinking", "Problem-Solving & Decision Making", "Relationships & Behavioral Change", "Ethical ideas for life development", "Finances", "Productivity"],
      credentialId: "None",
    },
    {
      ...
      date: "March 30, 2026",
      description: "Official certification recognizing completion of the Claude Code: The Coding Assistant course",
      skills: ["Claude Code", "Coding Assistant", "AI-Powered Development", "Code Generation", "Developer Productivity"],
      credentialId: "7fal4c6oau",
    },
    {
      title: "Claude 4.5: Smarter, Faster & More Human AI Certification",
      issuer: "Analytics Vidhya",
      date: "April 8, 2026",
      description: "Official certification recognizing completion of the Claude 4.5: Smarter, Faster & More Human AI course",
      skills: ["Claude 4.5", "AI Capabilities", "AI Applications", "Ethical AI Use", "Future of AI"],
      credentialId: "jnf20vidsp",
    },
